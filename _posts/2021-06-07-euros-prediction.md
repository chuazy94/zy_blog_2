...
<div class="row">
        <div class="column">
            <img alt="RMSE" src="{{ site.baseurl }}/images/Euro_2020_xG_RMSE.png" width="475" height="600">
        </div>
        <div class="column">
            <img alt="xG_over_goals" src="{{ site.baseurl }}/images/Euro_2020_goals_over_xg.png" width="475" height="600">
        </div>
</div>
